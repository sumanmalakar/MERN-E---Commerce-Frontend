  ...
  return (
    ...
    <div className="container text-center my-3">
      ...
      <div className="container text-center">
           <Link to={'/'} className="btn btn-warning mx-3 " style={{fontWeight:'bold'}}>Continue Shopping</Link>
           <Link to={'/profile'} className="btn btn-primary mx-3 " style={{fontWeight:'bold'}}>All Order's</Link>
      </div>
    </>
  );
}
